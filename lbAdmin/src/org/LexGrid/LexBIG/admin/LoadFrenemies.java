 ...
 */
@LgAdminFunction
public class LoadFrenemies {

    public static void main(String[] args) {
        try {
            new LoadFrenemies().run(args);
    ...
    public void run(String[] args) throws Exception {
        synchronized (ResourceManager.instance()) {
            ...
            FrenemiesLoader loader = (FrenemiesLoader) lbsm.getLoader(org.LexGrid.LexBIG.Impl.loaders.FrenemiesLoaderImpl.name);
